    ...
    <form id="formLogin" action="/login/auth" class="d-flex justify-content-center align-items-center" style="min-height: 100vh;" method="POST">
        <div class="col-11 col-sm-6 col-lg-4 mt-3 mb-3">
            <div class="bg-white p-4 rounded-1 border">
                <div class="row">
                    <h4 class="text-center text-primary-theme">codeRaiz</h4>
                ...
                <div class="row">
                    <div class="col-12 col-lg-12">
                        <div>
                            ...
                            <button id="access" name="access" preloader="true" type="button" class="btn btn-primary w-100" onclick="validateDataLogin(this);">ACESSAR</button>
                        </div>
                    </div>
                </div>
            </div>
